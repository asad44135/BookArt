        ...
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            ...
            <img src={logo} alt="Book Store App" height="50px" />
               <strong>BookArt</strong>              
            </h6>
            <p>
            BookArt is an Web application where the customer can purchase books online. Through this book store the users can search for a book by its title and later can add to the shopping cart and pay through any online mode.
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> group7@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> 9876543210
            </p>
            <p>
              <i className="fa fa-home mr-3" /> DAIICT, Gandhinagar
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
